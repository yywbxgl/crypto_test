...
#--------------sun-------------------
ARM_EMBEDDED_TOOLCHAIN="/home/sunqiliang/onnc/r1.2.0-ubuntu1604/r1.2.0/share/gcc-skymizer-8.3.0-x86_64_riscv64-linux-gnu/bin"
...
#-----------sun------------
ARM_EMBEDDED_SYSROOT="/home/sunqiliang/onnc/r1.2.0-ubuntu1604/r1.2.0/share/gcc-skymizer-8.3.0-x86_64_riscv64-linux-gnu/riscv64-unknown-linux-gnu"
#-----------sun------------

# Fix C++ header paths for Ubuntu
# ARM_EMBEDDED_TOOLCHAIN_VERSION="4.7.3"
ARM_EMBEDDED_TOOLCHAIN_VERSION="8.3.0"
...
if [ ! -d "$ARM_EMBEDDED_CXX_HEADERS/riscv64-unknown-linux-gnu" ]; then
  echo "ERROR: ARM_EMBEDDED_CXX_HEADERS is not valid"
  [ "$0" = "${BASH_SOURCE[0]}" ] && exit 1 || return 1
fi
...
if [ -z "$ARM_EMBEDDED_FLAGS" ]; then
  export ARM_EMBEDDED_FLAGS="-I$ARM_EMBEDDED_CXX_HEADERS -I$ARM_EMBEDDED_CXX_HEADERS/riscv64-unknown-linux-gnu "
fi
